...
var wasmBinaryFile;
  wasmBinaryFile = 'WasmImGuiTest.wasm';
...
function webgpu_preint() { var entry = __glue_main_; if (entry) { navigator["gpu"]; if (navigator["gpu"]) { navigator["gpu"]["requestAdapter"]().then( function(adapter) { adapter["requestDevice"]().then(function(device) { Module["preinitializedWebGPUDevice"] = device; entry(); }); }, function() { console.error("No WebGPU adapter; not starting"); }); } else { console.error("No support for WebGPU; not starting"); } } else { console.error("Entry point not found; unable to start"); } }
...
var ___start_em_js = Module['___start_em_js'] = 226156;
var ___stop_em_js = Module['___stop_em_js'] = 226624;
