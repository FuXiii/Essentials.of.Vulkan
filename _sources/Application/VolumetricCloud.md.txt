...
![Worley_Point](../_static/Hurst_Exponent.gif)  
...
![Worley_Point](../_static/Worly_Point.png)  
...
![base_cloud](../_static/base_colud.png)

而云一般没有这么圆润，一般都会有毛毛絮样的边缘，如下图所示：  
![base_cloud](../_static/detail_cloud.png)
...
![ray from camera](../_static/ray_from_camera.png)
...
![camera corrdinate](../_static/camera_coordinate.png)
...
![camera relative pos](../_static/camera_relative_pos.png)
...
![camera pixel pos](../_static/camera_pixel_pos.png)
...
![base_ray_marching](../_static/base_ray_marching.gif)
...
![camera pixel pos](../_static/raymarching.png)
...
![camera pixel pos](../_static/bounding_sphere.png)
...
![camera pixel pos](../_static/bounding_box.png)
...
如下图所示：  
![camera pixel pos](../_static/ray_surface_intersect.png)
...
![camera pixel pos](../_static/intersect_case_out_box_forward.png)
...
![camera pixel pos](../_static/intersect_case_in_box.png)

其中A，B两点为交点，相交于A点的交点由于其La是负值，说明在相机背后，如果交点到相机的距离量为负值，则将负值的那个交点丢弃，换成射线的起点C作为与包围盒的起点，点B作为终点。

如下图相机在包围盒外，背对包围盒

![camera pixel pos](../_static/intersect_case_out_box_backward.png)
...
![camera pixel pos](../_static/ray_marching_bounding_box.gif)
...
![camera pixel pos](../_static/bounding_box_sample_space.png)
...
![camera pixel pos](../_static/ray_marching_bounding_box_sample_space.gif)
...
![camera pixel pos](../_static/ray_marching_bounding_box_sample_3d_noise.gif)
...
![camera pixel pos](../_static/ray_marching_bounding_box_sample_3d_noise_erase_strip.gif)
...
*注：该章节主要来源于[Production Volume Rendering SIGGRAPH 2017 Course](../_static/volumePaper.pdf)*
